<x-base-site>
    ...
    <div class="bg-green-100 py-14">
        <h3 class="text-2xl tracking-widest text-green-600 text-center">FONCTIONNALITÉS</h3>
        <h1 class="mt-8 text-center text-5xl text-green-600 font-bold">Nos fonctionnalités et services.</h1>
        ...
        <div class="md:flex md:justify-center md:space-x-8 md:px-14">
            ...
            <div class="mt-16 py-4 px-4 bg-whit w-72 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                <div class="w-sm">
                    ...
                    <div class="mt-4 text-green-600 text-center">
                        <h1 class="text-xl font-bold">Communication</h1>
            ...
            <div class="mt-16 py-4 px-4 bg-whit w-72 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                <div class="w-sm">
                    ...
                    <div class="mt-4 text-green-600 text-center">
                        <h1 class="text-xl font-bold">Conception inspirée</h1>
            ...
            <div class="mt-16 py-4 px-4 bg-whit w-72 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
                <div class="w-sm">
                    ...
                    <div class="mt-4 text-green-600 text-center">
                        <h1 class="text-xl font-bold">Clients satisfaits</h1>
